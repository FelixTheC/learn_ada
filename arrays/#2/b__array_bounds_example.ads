...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_array_bounds_example" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#38c2b34f#;
   pragma Export (C, u00001, "array_bounds_exampleB");
