...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#215daae9#;
   ...
   u00114 : constant Version_32 := 16#708d8401#;
   pragma Export (C, u00114, "bookB");
   u00115 : constant Version_32 := 16#2750d336#;
   pragma Export (C, u00115, "bookS");
   u00116 : constant Version_32 := 16#054b1645#;
   pragma Export (C, u00116, "book__additional_operationsB");
   u00117 : constant Version_32 := 16#059115c8#;
   pragma Export (C, u00117, "book__additional_operationsS");
   ...
   --  book%s
   --  book%b
   --  book.additional_operations%s
   --  book.additional_operations%b
   --  main%b
