...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_undetected_imperial_metric_error" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#506b363f#;
   pragma Export (C, u00001, "undetected_imperial_metric_errorB");
   ...
   u00114 : constant Version_32 := 16#8f828546#;
   pragma Export (C, u00114, "system__img_realB");
   u00115 : constant Version_32 := 16#d9ae7b96#;
   ...
   u00119 : constant Version_32 := 16#54da27e6#;
   pragma Export (C, u00119, "system__img_lluB");
   u00120 : constant Version_32 := 16#51339ed5#;
   pragma Export (C, u00120, "system__img_lluS");
   u00121 : constant Version_32 := 16#16458a73#;
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  undetected_imperial_metric_error%b
