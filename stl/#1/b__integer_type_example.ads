...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_integer_type_example" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#36975692#;
   pragma Export (C, u00001, "integer_type_exampleB");
