...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mutally_recursive_subprograms" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c746530e#;
   pragma Export (C, u00001, "mutally_recursive_subprogramsB");
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  mutally_recursive_subprograms%b
