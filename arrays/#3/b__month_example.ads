...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_month_example" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9a06d443#;
   pragma Export (C, u00001, "month_exampleB");
   ...
   u00121 : constant Version_32 := 16#2779eac4#;
