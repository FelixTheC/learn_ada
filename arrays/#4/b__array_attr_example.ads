...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_array_attr_example" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7c4bf7b3#;
   pragma Export (C, u00001, "array_attr_exampleB");
