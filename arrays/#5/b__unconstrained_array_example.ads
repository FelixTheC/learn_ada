...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_unconstrained_array_example" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a48a358f#;
   pragma Export (C, u00001, "unconstrained_array_exampleB");
